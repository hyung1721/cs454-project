...
class Animal:
    def __init__(self):
        self.name = ""        # Can increase (public -> protected)
        self._age = 0        # Can increase (protected -> private)
        self.__type = "pet"  # Cannot increase (already private)
...
class Giraffe(Animal):
    ...
    test_refactoring("refactoring/target_libraries/test_library", DecreaseFieldAccess)
